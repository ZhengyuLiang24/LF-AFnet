...
%% Parameters setting
angRes = 9;                 % Angular Resolution, options, e.g., 3, 5, 7, 9. Default: 9
factor = 2;                 % SR factor
...
for index_dataset = 1 : num_datasets
    ...
    src_sub_dataset = [src_data_path, name_dataset, '/train/'];
    ...
    for index_scene = 1 : num_scene 
        ...
        for h = 1 : stride : H - patchsize + 1
            for w = 1 : stride : W - patchsize + 1
                ...
                SavePath = ['./data_for_train/x', num2str(factor), '_SR/', name_dataset,'/' ];
